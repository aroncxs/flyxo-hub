...
local skins = {"RegularGubby", "FatGubby", "StormcellGubby", "PancakeGubby"}
...
for _, skinName in ipairs(skins) do
   ...
   print("Game not supported. Please join one of our supported games, it's on our Discord (https://discord.gg/UXgGqZ7w3v)")
end
